...
brew fdk-aac
brew ffmpeg --HEAD --with-fdk-aac --with-libass --with-libvorbis --with-libvpx --with-x265 --without-libvo-aacenc
brew fontconfig
brew fontforge
brew freetype
brew fribidi
...
brew ghostscript
brew ghq --HEAD
brew git --HEAD --with-blk-sha1 --with-pcre --with-persistent-https
brew glib
brew gmp
brew go --HEAD
